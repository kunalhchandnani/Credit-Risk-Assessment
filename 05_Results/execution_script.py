...
full_path ='02_Data/02_Validation/' + data_file_name
...
path_pipe_ejecucion_pd = '04_Models/' + name_pipe_execution_pd
path_pipe_ejecucion_ead = '04_Models/' + name_pipe_execution_ead
path_pipe_ejecucion_lgd = '04_Models/' + name_pipe_execution_lgd
